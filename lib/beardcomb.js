...
beardcomb.compile = function(source, options) {
    ...
    if (typeof source == 'string') {
        return function(options) {
            ...
            for (var idx = 0; idx < options.partials.length; idx++) {
                if (typeof options.partials[idx].r == 'function') continue;
                options.partials[idx] = hogan.compile(options.partials[idx]);
            }
